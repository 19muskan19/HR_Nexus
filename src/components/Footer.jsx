...
const Footer = () => {
  const services = [
    ...
    { name: 'Timesheets & Projects', path: '/services/timesheets-projects' },
    { name: 'Learning Management', path: '/services/learning-management' },
    { name: 'Marketplace', path: '/services/marketplace' },
    { name: 'Data Protection', path: '/services/data-protection' },
  ]

  return (
    <footer className="bg-gray-800 dark:bg-gray-900 text-gray-300 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Modern HR solutions for the digital age. Streamline your workforce management with our comprehensive platform.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} HR NEXUS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
